...
function Detail() {
  var hostname = "https://www.quokkanim.tk/api/v1";
  var path = "https://www.quokkanim.tk/api/v1";
      ...
      <div className="detail" key={index}>
        ...
        <div className="detailinfo">
          <div className="infobutton">
            ...
            {savestatus == 1 && <button className="savebutton" style={{ backgroundColor: '#db2a2a', borderColor: '#db2a2a' }} onClick={movecollection}>Clear</button>}
          </div>
